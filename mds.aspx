...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="jumbotron">
        ...
        <p class="lead">
            地址:<asp:TextBox ID="TextBox1" runat="server" Width="573px" TextMode="Url">https://yourdomain:6443</asp:TextBox>
        </p>
        <p class="lead">
            密钥:<asp:TextBox ID="TextBox2" runat="server" Width="574px">your token</asp:TextBox>
        </p>
        <p>
